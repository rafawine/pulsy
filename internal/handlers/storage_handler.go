...
func UploadFileHandler(c *gin.Context) {
	...
	err = services.UploadFile(os.Getenv("PULSY_STORAGE_BUCKET"), bucketFileName, file)
	...
	if err != nil {
		...
		bucketErr := services.DeleteFile(os.Getenv("PULSY_STORAGE_BUCKET"), bucketFileName)
...
func DownloadFileHandler(c *gin.Context) {
	...
	err = services.DownloadFile(os.Getenv("PULSY_STORAGE_BUCKET"), bucketFileName, tempFile.Name())
	if err != nil {
